public class AlgoritmoAES {
    ...
    public static void main(String[] args) {
        ...
        byte[] chave = {0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f, 0x50};
        ...
        for (int i = 0; i < chave.length; i++) {
            ...
            keySchedule[0][coluna][linha] = chave[i];
            linha++;
        }
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            byte[] parteFinal = keySchedule[i-1][3];
            ...
            roundConstant[0] = getConstant(i-1);
            ...
            byte[] parteInicial = keySchedule[i-1][0];
            ...
            for (int j = 1; j < 4; j++) {
                byte[] xor3 = xorWord(keySchedule[i-1][j], roundkey[j-1]);
                roundkey[j] = xor3;
            }
...
/*
        ...
        byte[] teste = {0x45,0x46,0x47,0x48};
        byte[] teste2 = xorWord(teste, xor2);

        System.out.println(bytesToHex(teste2));


        teste = new byte[]{0x49, 0x4a, 0x4b, 0x4c};
        teste2 = xorWord(teste, teste2);
        ...
        teste = new byte[]{0x2a, (byte) 0x80, 0x57, (byte) 0xef};
        teste2 = new byte[]{0x32,0x2b,0x1d, (byte) 0x96};
        teste2 = xorWord(teste, teste2);
        ...
        System.out.println(String.format("%02x", 94));*/
